        ...
        <Container>
          <div className="aboutBox">
            <div className="about_leftBox">
              <h1>Hi, I'm Vikash Vashistha.</h1>
              <p>
                I am Full Stack Web Developer and i have knowledge in HTML, CSS,
                JS, Mongodb, PostgreSQL, Express, ReactJS, NodeJS and make
                user-friendly websites.
              </p>
              <a href="https://drive.google.com/uc?export=download&id=10v-NKg8emajR7LZEmxW2sLXy6qV7mbaR">
                <button>
                  Download CV
                  <DownloadIcon />
                </button>
        ...
        <AboutMeWrapper>
          <div className="aboutSection">
            <div className="left">
              ...
              <p></p>
              <p>
                Email: <span>vikashvashistha.dev@gmail.com</span>
              </p>
              <p>
            ...
            <div className="right">
              ...
              <p>
                My name is Vikash Vashistha, I am from Hindaun City, Rajasthan.
                Passionate Full Stack Web Developer with skills in the MERN
                stack, I have learned Full Stack Web Development in Masai
                school. Skilled in problem- solving and execution of software
                tasks from start to finish. I look forward to joining a company
                where I can contribute to individual and company growth..
              </p>
              <div>
